           ...
           <ul>
               ...
               <?php  
                    ...
                    $sentencia="select * from usuario inner join ciudad on usuario.id_city=ciudad.id_city WHERE email_user = :mail";
                     ...
                     {
                         ?>
                         <li><img class='perfil' src="<?php echo $consulta["photo"]?>" ></li>
                        <?php
                     }
                            ...
                            try
                            {
                                ...
                                $resul->execute (array(
                                    ...
                                    while($consulta=$resul->fetch(PDO::FETCH_ASSOC))
                                    {
                                        ?>
                                            <center>
                                                <form action="photo_config_proceso.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <tr class="tr">
                                                 ...
                                                 <tr>
                                                    <td><label for="photo">Foto de perfil</label><input accept="image/*" type="file" name="photo" id="photo">
                                                </tr>
                                                <tr>
